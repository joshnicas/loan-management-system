...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT *  FROM debtor WHERE fullname = '$fullname'";
    $result = $conn->query($sql);

    $sql2 = "SELECT *  FROM loan_refund WHERE fullname = '$fullname'";
...
<body>
    ...
    <div id="content_div">
        <div id="content_heading">
           ...
           <p><b>MKOPO ALIYOCHUKUA:</b> </p><p><?php echo $client2['loan_taken']; ?></p>
           <p><b>MKOPO ANAOTAKIWA KUREJESHA:</b> </p><p><?php echo $client2['loan_to_be_refunded']; ?></p>
        ...
        <form action="./includes/clientrefund.inc.php" method="post"> 
        <input type="hidden" name="fullname" value="<?php echo $client['fullname'];?>">
        <input type="number" name="amount" placeholder="REJESHO"><br><br>
